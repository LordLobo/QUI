    ...
    profile = {
        ...
        general = {
            ...
            popupBlocker = {
                ...
                blockMicroButtonGlows = false, -- Golden FlashBorder glow on any micromenu button (collections, achievements, etc.)
        ...
        actionBars = {
            ...
            global = {
                ...
                usabilityColor = {0.4, 0.4, 0.4, 1},  -- Unusable button tint color
        ...
        quiUnitFrames = {
            ...
            boss = {
                ...
                offsetX = 974,
                offsetY = 106,
                spacing = 35,           -- Legacy vertical spacing between boss frames
                growDirection = "DOWN", -- Boss frame group direction: UP, DOWN, LEFT, RIGHT
                xSpacing = 35,          -- Horizontal spacing between boss frames
                ySpacing = 35,          -- Vertical spacing between boss frames
                texture = "Quazii v5",
                useClassColor = true,
                useHostilityColor = true,
